...
{
    public class QuotationSystem3Service : IQuotationSystem3Service
    {
        ...
        public QuotationSystem3Service(IOptions<QuotationSystem3Settings> quotationSystem3Settings)
        {
